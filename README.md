...
<table align="center">
 ...
 1인 가구가 증가함에 따라 1인 식단 관리, 운동 등 헬스케어 관련 서비스들이 점차 증가하고 있다. 하지만 기존 식단 관리 서비스는 사용자가 직접 데이터를 입력해야 하는 번거로움이 있고, 운동 관리 서비스는 실시간으로 자세 피드백을 받기 어렵다는 한계가 있다. 또한, 혼자 사는 사람들이 낙상과 같은 사고를 겪을 경우 신속하게 대처하기 어렵다는 문제도 있다. 이러한 점들을 해결하기 위해 NahonLab 팀은 딥러닝 기술을 활용한 운동, 식단, 건강 관리 기능을 통합한 서비스를 개발하려 한다.
