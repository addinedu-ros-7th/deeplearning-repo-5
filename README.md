...
## [전체 시연 영상](https://youtube.com/shorts/AUdVKNk_UV8?si=kb7C2WoPwqL_4VAp)
...
| **카테고리** | **기능**            | **설명**                                                                 |
|:--------------:|---------------------|-------------------------------------------------------------------------|
| **기록 확인**    | 식단 기록 확인       | 사용자가 설정한 기간의 식단 기록 확인                                      |
|              | 운동 기록 확인       | 사용자가 설정한 기간의 운동 기록 확인                                      |
|              | 위험 상황 기록 확인   | 사용자가 설정한 기간의 위험 상황 기록 확인                                  |
