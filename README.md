...
1인 가구가 증가함에 따라 혼자서도 식단 관리와 운동을 할 수 있도록 돕는 헬스케어 서비스가 점점 더 많아지고 있습니다. 그러나 기존의 식단 관리 서비스는 사용자가 직접 데이터를 입력해야 하는 번거로움이 있고, 운동 관리 서비스는 실시간으로 자세 피드백을 제공하기 어렵다는 한계가 있습니다. 또한, 혼자 사는 사람들은 낙상과 같은 사고가 발생했을 때 신속히 대처하기 어려운 상황에 놓이기도 합니다.
이러한 문제를 해결하기 위해 NahonLab 팀은 딥러닝 기술을 활용해 운동, 식단, 건강 관리 기능을 통합한 서비스를 개발했습니다.
